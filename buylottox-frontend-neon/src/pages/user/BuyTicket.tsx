        ...
        <div className="blx-panel-strong overflow-hidden">
          <div className="relative p-6">
            ...
            <div className="relative">
              ...
              <div className="mt-2 text-4xl font-extrabold">$5,000,000</div>
              <div className="mt-2 text-sm text-white/55">{active ? `${active.title} • Active Draw` : 'Loading draw…'}</div>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-6">
        <div className="blx-panel p-6">
          ...
          <p className="mt-3 text-xs text-white/40">
            This is mock mode. When backend is ready, swap services to API.
          </p>
        </div>
      </div>
    </div>
